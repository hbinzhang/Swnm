		...
		<div id="main_content_container">
			...
			<div id="content_container">
				...
				<div class="roleadd_container" style="">
					...
					<form  action="" method="post" id="editassessment_form">
						<div class="top10">
							...
							<div class="text_form left" >
				    			...
				    			<select id="select_assessment_kaohejigouzerenren" name="assessment.orgPerson" class="normalselect" style="width:665px;">							
								    <c:forEach items="${orgPersonList}" var="lv">
					    				<c:choose>
					    					<c:when test="${lv.id eq assessment.orgPerson}">
							...
							<div class="text_form left">
				    			...
				    			<select id="reviewer" name="assessment.reviewer" class="normalselect" style="width:665px;">							
		    						<c:forEach items="${assessPersonList}" var="lv">
					    				<c:choose>
					    					<c:when test="${lv.id eq assessment.reviewer}">
						    					<option value="${lv.id }" selected="selected">${lv.name }</option>
						    				</c:when>
						    				<c:otherwise>
						    					<option value="${lv.id }">${lv.name }</option>
						...
						<div class="top5 left50">
							<input type="button" value="保存" class="btn left10" id="editassessment_btn" />
