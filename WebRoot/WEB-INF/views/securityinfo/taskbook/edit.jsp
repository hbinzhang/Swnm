		...
		<div id="main_content_container">
			...
			<div id="content_container">
				<div class="roleadd_container">
					...
					<form  action="" method="post" id="edittaskbook_form">
						<div class="top10">
							<div class="text_form left">
								...
								<input type="text" name="taskBook.name" value="${taskBook.name}" id="name" readonly="readonly" class="normaltext disabletext" style="width:759px;">
								<div class="clear"></div>
							</div>
							<div class="clear"></div>
							<div class="text_form left">
							...
							<div class="text_form left" >
								...
								<select id="taskBook.type" name="taskBook.type" class="normalselect">							
		    						<c:choose>
							...
							<div class="text_form left"  >
								...
								<input type="text" name="taskBook.planTime" value="<fmt:formatDate value="${taskBook.planTime }" pattern="yyyy-MM-dd HH:mm:ss"/>" style="width: 282px;" class="normaltext disabletext" readonly="readonly" id="plantime"  />
							...
							<div class="text_form left"  >
								...
								<input type="text" name="taskBook.issueTime" value="<fmt:formatDate value="${taskBook.issueTime }" pattern="yyyy-MM-dd HH:mm:ss"/>" style="width: 282px;" class="normaltext disabletext"  readonly="readonly" id="issuetime"  />
								<a href="javascript:void(0)" class="underlinenone">
									<img  src="<c:url value="/resources/images/datePicker.gif" />" width="16" height="22" align="absmiddle" />
								</a>
								<div class="clear"></div>
							...
							<div class="text_form left">
								...
								<input type="text" name="taskBook.startTime" value="<fmt:formatDate value="${taskBook.startTime }" pattern="yyyy-MM-dd HH:mm:ss"/>" style="width: 282px;" class="normaltext validate[required] datepicker" id="starttime" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',maxDate:'#F{$dp.$D(\'endtime\',{s:-1})}' ,minDate:'#F{$dp.$D(\'plantime\',{s:1})}'})" />
								<a href="javascript:void(0)" class="underlinenone">
							...
							<div class="text_form left">
								...
								<input type="text" name="taskBook.endTime" value="<fmt:formatDate value="${taskBook.endTime}" pattern="yyyy-MM-dd HH:mm:ss"/>" style="width: 282px;" class="normaltext validate[required] datepicker" id="endtime" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',minDate:'#F{$dp.$D(\'starttime\',{s:1})}'})" />
								<a href="javascript:void(0)" class="underlinenone">
							...
							<div class="text_form left">
				    			...
				    			<input type="text" name="taskBook.planOrgName" value="${taskBook.planOrgName }" id="planOrgName"  style="width:300px;" readonly="readonly" class="normaltext disabletext">			    												    			
								<div class="clear"></div>
							</div>
							 <div class="text_form left">
								...
								<input type="text" name="taskBook.planOrgPersonName " value="${taskBook.planOrgPersonName }" id="planOrgPersonName "  style="width:300px;" readonly="readonly" class="normaltext disabletext ">
								<div class="clear"></div>
							</div>					
							<div class="clear"></div>
						   	<div class="text_form left">
						    ...
						    <div class="text_form left"  >
								...
								<select id="select_taskbook_zerenjigouren" name="taskBook.inChargeOrgPerson" class="normalselect validate[required]">										
									<c:forEach items="${inChargeOrgPersonList}" var="lv">
					    				<c:choose>
					    					<c:when test="${lv.id eq taskBook.inChargeOrgPerson }">
						...
						<div class="top5 left40">
							<input type="button" value="保存" class="btn left20" id="edittaskbook_btn" />
