		...
		<div id="main_content_container">
			...
			<div id="content_container">
				...
				<div class="roleadd_container" style="min-height:610px;">
					...
					<form  action="" method="post" id="editrectification_form">
						<div class="top10">
							...
							<div class="text_form left">
					    		...
					    		<input type="text" name="rectification.name" value="${rectification.name}" id="name" class="normaltext disabletext"  readonly="readonly"  style="width:652px;">				    						    		
					    		<div class="clear"></div>
							</div>
							<div class="clear"></div>
							<div class="text_form left">
						...
						<div class="top5 left50">
							<input type="button" value="保存" class="btn left10" id="editrectification_btn" />
