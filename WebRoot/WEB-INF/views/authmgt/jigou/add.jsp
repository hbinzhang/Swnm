		...
		<div id="main_content_container">
			...
			<div id="content_container">
				<div class="roleadd_container">
					<form action="<c:url value='/authmgt/createOrganization'></c:url>" method="post" id="organizationform">
						<c:choose>
						...
						<div>
							<div class="text_form left">
								...
								<input type="text" value="${organization.orgNm }" name="organization.orgNm" id="name" class="validate[required] normaltext" style="width:500px;">
								<div class="clear"></div>
							</div>
							<div class="text_form left" style="margin-left:100px;">
								<label class="labelname" for="">组织机构代码:</label>
								<input type="text" value="${organization.orgId }" name="organization.orgId" id="orgid" class="normaltext validate[required,maxSize[9],custom[onlyLetterNumber]]" style="width:500px;">
								<div class="clear"></div>
							</div>
							<div class="clear"></div>
						</div>
						<div>
							...
							<div class="text_form left">
								...
								<input type="text" value="${organization.remark }" name="organization.remark" id="remark" class="normaltext" style="width:500px;">
								<div class="clear"></div>
							</div>
							<div class="clear"></div>
						</div>
