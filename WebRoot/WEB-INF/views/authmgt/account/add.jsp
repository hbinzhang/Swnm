					...
					<form action="<c:url value="/authmgt/createAccount"></c:url>" method="post" id="accountform">
						...
						<div>
							<div class="text_form left">
								...
								<input type="text" name="account.id" value="${account.id }" id="accountid" class="normaltext validate[required,custom[gonghao],maxSize[20]]">
								<div class="clear"></div>
							</div>
							<div class="text_form left">
						...
						<div>
							...
							<div class="text_form left">
								...
								<input type="text" name="account.remark" value="${acount.remark }" id="remark" class="normaltext validate[maxSize[500]]" style="width:710px;">
								<div class="clear"></div>
							</div>
							<div class="clear"></div>
						</div>
