		...
		<div id="main_content_container">
			...
			<div id="content_container">
				<div class="roleadd_container">
					<form action="<c:url value='/authmgt/updateRole'></c:url>" method="post" id="roleform">
						<c:choose>
						...
						<div>
							<div class="text_form left">
								<label class="labelname" for="">角色名称:</label>
									<input type="text" class="normaltext disabletext validate[required]" name="role.name" value="${role.name }" readOnly="readonly">
								<div class="clear"></div>
							</div>
							<div class="text_form left">
