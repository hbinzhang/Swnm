		...
		<div id="main_content_container">
			...
			<div id="content_container">
				<div class="normal_tab">
				  	<ul>
					    <li><a class="selected" href="<c:url value='/views/rizhi/anquan.jsp'></c:url>">安全日志</a></li>
						<li><a href="<c:url value='/views/rizhi/caozuo.jsp'></c:url>">操作日志</a></li>
				  	</ul>
			    </div>
					...
					<table class="tableui">
				        ...
				        <tbody>
				        	<c:forEach begin="1" end="10">
				        		<tr>        
							        <td>
							        	<a href="javascript:void(0);" class="detail anquan_detail">001</a>
							        </td>
							        <td>001</td>
