					...
					<form action="" method="post">
						<div>
							<div class="text_form left">
								...
								<input type="text" name="" value="34234" id="" class="normaltext" readonly="readonly" disabled="disabled">
								<div class="clear"></div>
							</div>
							<div class="text_form left">
								...
								<div id="contab01">
									<div>
										<div class="text_form left">
											...
											<select id="" class="normalselect" disabled="disabled">
										...
										<div class="text_form left">
											...
											<select class="normalselect" id="fangqu_weilanleixing" disabled="disabled">
