					...
					<form action="" method="post" class="left50 top30" id="weilan_form">
						<div>
							<div class="text_form top5" style="margin-top:10px;">
								...
								<input type="text" name="" id="" class="normaltext" style="width: 500px;" readonly="readonly" disabled="disabled">
								<span class="input_tip">*主机ID要符合一定的规范</span>
								<div class="clear"></div>
							</div>
							<div class="text_form top5" style="margin-top:10px;">
								<label class="labelname" for="">围栏类型:</label>
								<select id="" class="normalselect"  style="width: 513px;" disabled="disabled">
