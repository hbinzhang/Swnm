		...
		var methods = {
			init : function(params) {
				var _defaults = {
					...
					onSearchBut: function() {},
					onSelectAllBut: function() {},
					onCancelAllBut: function() {},
					onReserveAllBut: function() {},
					onLoad: function() {},
					onClose: function() {}
				};
				...
				if (elem.next('div').hasClass(elemClass)) {
					...
					elemObj.find('[data-popModalBut="search"]').bind('click', function() {
						if (_options.onSearchBut && $.isFunction(_options.onSearchBut)) {
							_options.onSearchBut();
						}
					});
					
					elemObj.find('[data-popModalBut="selectall"]').bind('click', function() {
						if (_options.onSelectAllBut && $.isFunction(_options.onSelectAllBut)) {
							_options.onSelectAllBut();
						}
					});
					
					elemObj.find('[data-popModalBut="cancelall"]').bind('click', function() {
						if (_options.onCancelAllBut && $.isFunction(_options.onCancelAllBut)) {
							_options.onCancelAllBut();
						}
					});
					
					elemObj.find('[data-popModalBut="reserveall"]').bind('click', function() {
						if (_options.onReserveAllBut && $.isFunction(_options.onReserveAllBut)) {
							_options.onReserveAllBut();
						}
					});
	...
	$.fn.dialogModal = function(method) {
		...
		var methods = {
			init : function(params) {
				...
				dialogContainer = $('<div class="' + elemClass + '_container" style="width:'+wid+'%;"></div>'),
				...
				function bindFooterButtons() {
					...
					elemObj.find('[data-dialogModalBut="search"]').bind('click', function() {
						if (_options.onSearchBut && $.isFunction(_options.onSearchBut)) {
							_options.onSearchBut();
						}
					});
					
					elemObj.find('[data-dialogModalBut="selectall"]').bind('click', function() {
						if (_options.onSelectAllBut && $.isFunction(_options.onSelectAllBut)) {
							_options.onSelectAllBut();
						}
					});
					
					elemObj.find('[data-dialogModalBut="cancelall"]').bind('click', function() {
						if (_options.onCancelAllBut && $.isFunction(_options.onCancelAllBut)) {
							_options.onCancelAllBut();
						}
					});
					
					elemObj.find('[data-dialogModalBut="reserveall"]').bind('click', function() {
						if (_options.onReserveAllBut && $.isFunction(_options.onReserveAllBut)) {
							_options.onReserveAllBut();
						}
					});
