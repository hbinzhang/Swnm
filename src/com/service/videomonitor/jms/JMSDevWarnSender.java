...
public class JMSDevWarnSender extends JMSSenderConfig{
	...
	public int getAlarm(WarnInfo wi){
	    ...
	    alarm.setInfo(wi.getRemarks());
		return 0;
	}
	
	public int warnSend(WarnInfo wi) throws NamingException, JMSException{
		if (getAlarm(wi) != 0){
			logger.error("getAlarm return error!");
			return -1;
		}
		if(jndiFactory==null || providerUrl==null || connFactoryJNDI==null || alarmQueue==null){
