...
package common.justobjects.pushlet.servlet;
...
import common.justobjects.pushlet.Version;
import common.justobjects.pushlet.core.Command;
import common.justobjects.pushlet.core.Config;
import common.justobjects.pushlet.core.Dispatcher;
import common.justobjects.pushlet.core.Event;
import common.justobjects.pushlet.core.EventParser;
import common.justobjects.pushlet.core.EventSourceManager;
import common.justobjects.pushlet.core.Protocol;
import common.justobjects.pushlet.core.Session;
import common.justobjects.pushlet.core.SessionManager;
import common.justobjects.pushlet.util.Log;
import common.justobjects.pushlet.util.Servlets;
...
public class Pushlet extends HttpServlet implements Protocol {
	...
	public static Map<String, String> mapInfo = new java.util.Hashtable<String, String>();
	...
	public void init() throws ServletException {
		try {
			...
			System.out.println("Pushlet{}    webInfPath:"+webInfPath);
			...
			//create_inst
			Dispatcher.checkCreateInstance();
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			for (Enumeration e = request.getParameterNames(); e.hasMoreElements();) {
				...
				if ("p_id".equals(nextAttribute)) {
					if (null == mapInfo.get(request.getParameter(nextAttribute))) {
						if (null ==request.getParameter("name"))
						{
							mapInfo.put(request.getParameter("p_id"), new String(request
									.getParameter("p_id").getBytes("ISO-8859-1"), "utf-8"));
						}
						else
						{
							mapInfo.put(request.getParameter("p_id"), new String(request
	...
	protected void doRequest(Event anEvent, HttpServletRequest request,
		...
		try {
			...
			System.out.println("===============doRequest eventType:"+eventType+"---"+curtime);*/
