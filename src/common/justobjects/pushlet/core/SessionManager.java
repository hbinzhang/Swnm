...
import common.justobjects.pushlet.util.Rand;
import common.justobjects.pushlet.util.Sys;
...
public class SessionManager implements ConfigDefs {
	...
	static {
		...
		try {
			instance = (SessionManager) Config.getClass(SESSION_MANAGER_CLASS, "common.justobjects.pushlet.core.SessionManager").newInstance();
