...
class XMLAdapter implements ClientAdapter {
	...
	public void start() throws IOException {
		...
		System.out.println("==============XMLAdapter=start :"+curtime);*/
	...
	public void push(Event anEvent) throws IOException {
		...
		SimpleDateFormat sdFormatter = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
		String curtime = sdFormatter.format(nowTime);
		System.out.println("==============XMLAdapter=push :"+curtime);
		System.out.println("==============XMLAdapter=push :"+anEvent.toXML(strictXML));*/
	...
	public void stop() throws IOException {
		...
		SimpleDateFormat sdFormatter = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
		String curtime = sdFormatter.format(nowTime);
		System.out.println("==============XMLAdapter=stop :"+curtime);*/
