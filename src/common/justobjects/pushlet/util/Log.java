...
package common.justobjects.pushlet.util;

import common.justobjects.pushlet.core.Config;
import common.justobjects.pushlet.core.ConfigDefs;
...
public class Log implements ConfigDefs {
	...
	static public void init() {
		try {
			logger = (PushletLogger) Config.getClass(LOGGER_CLASS, "common.justobjects.pushlet.util.DefaultLogger").newInstance();
		} catch (Throwable t) {
